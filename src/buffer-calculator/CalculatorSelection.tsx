...
const Radio = ({ checked }: { checked: boolean }) => (
	<div className="rounded-full border-2 border-darkBlue w-5 h-5 flex items-center justify-center ">
		<div className={`rounded-full bg-darkBlue w-3 h-3 transition-transform ${checked ? "scale-100" : "scale-0"}`} />
	</div>
);
